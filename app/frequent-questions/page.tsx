    ...
    <>
      ...
      <div className='info-container'>
        ...
        <div className='faq'>
          <h2>¿Qué es Gesmia?</h2>
          <p>
            Gesmia es una aplicación de seguridad personal diseñada para mejorar la seguridad de los usuarios a través de funcionalidades como seguimiento en tiempo real, alertas SOS, geofencing y reportes de incidentes.
          </p>
          <h2>¿Cuáles son las características principales de Gesmia?</h2>
          <p>
          ...
          <h2>¿Cuánto cuesta usar Gesmia?</h2>
          <p>
          ...
          <h2>¿Cómo me registro en Gesmia?</h2>
          <p>
          ...
          <h2>¿Qué dispositivos son compatibles con Gesmia?</h2>
          <p>
            Gesmia es compatible con dispositivos Android e iOS. También ofrecemos un dispositivo de hardware llamado Tapp que se integra con la aplicación para mayor seguridad.
          </p>
          ...
          <h2>¿Qué tan segura es la información que proporciono a Gesmia?</h2>
          <p>
            Gesmia utiliza protocolos de cifrado robustos y medidas estrictas de privacidad para proteger la información de los usuarios.
          </p>
          ...
          <h2>¿Gesmia funciona en mi país?</h2>
          <p>
            Gesmia está disponible en múltiples países, incluyendo España, México, Brasil, Argentina, Centro America y varios más en América Latina y Europa Occidental.
          </p>
          <h2>¿Qué debo hacer si tengo problemas con la aplicación?</h2>
          <p>
            Puedes contactar al soporte de Gesmia a través de la sección de ayuda en la aplicación o enviando un correo electrónico a nuestro equipo de soporte. (soporte@Gesmia.com)
          </p>
        </div>
      </div>
    </>
